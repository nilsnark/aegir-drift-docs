...
- An ECS-based architecture for entities and systems.
...
- Nested realities (pocket dimensions, virtual constructs).
- Multiscale ship and base building.
- Player-driven automation and computing through a player scripting-runtime.
...
- Wormholes
- Seedships
- NPF (negative potential flux)
- Advanced automation via SLISP

Fold is the first universe, not the only one.
